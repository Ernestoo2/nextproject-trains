  ...
  return (
    <div className="relative border border-[#79747E] p-3 rounded-md flex items-center gap-3 text-sm">
      ...
      >
        ...
        <FaCaretDown
          className={`text-[#77747E] ml-auto transition-transform duration-200 
                    ${isOpen ? "rotate-180" : ""}`}
        />
      </button>
      {/* {dropdown menu} */}
      {isOpen && (
        <div className="absolute left-0 z-10 mt-1 bg-white border-gray-200 rounded-md shadow-lg top-full ">
